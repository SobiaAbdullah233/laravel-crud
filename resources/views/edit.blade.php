...
<html>
  ...
  <body>
    ...
    @endif
        ...
        <div class="col-md-6">
      <form action="{{ url('editform')}}/{{$user->id}}" method="post">
        @csrf
        @method("put")
        <div class="banner">
        ...
        <div class="colums">
          <div class="item">
            ...
            <input id="fname" type="text" name="fname" value="{{$user->fname}}" required/>
            @error('fname')
          ...
          <div class="item">
            ...
            <input id="address1" type="text"   name="address1" value="{{$user->address1}}" required/>
            @error('address1')
            <div class="text-white bg-danger w-100 p-1 ">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="item">
            ...
            <input id="address2" type="text"   name="address2"  value="{{$user->address2}}" required/>
            @error('address2')
            <div class="text-white bg-danger w-100 p-1 ">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="item">
            ...
            <input id="state" type="text"   name="state" value="{{$user->state}}" required/>
            @error('state')
            <div class="text-white bg-danger w-100 p-1 ">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="item">
            ...
            <input id="zip" type="text" name="zip" value="{{$user->zip}}" required/>
            @error('zip')
            <div class="text-white bg-danger w-100 p-1 ">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="item">
            ...
            <input id="city" type="text"   name="city" value="{{$user->city}}" required/>
            @error('city')
            <div class="text-white bg-danger w-100 p-1 ">{{ $message }}</div>
            @enderror
          </div>
        ...
        <div class="question">
          ...
          <div class="category">
            <div>
              <input type="radio"  @if($user->category == 'standard') checked @endif id="radio_1" value="standard" name="category"/>
              <label for="radio_1" class="radio"><span>Standard</span></label>
            </div>
            <div>
              <input  type="radio" @if($user->category == 'premium') checked @endif  id="radio_2" value="premium" name="category"/>
              <label for="radio_2" class="radio"><span>Premium</span></label>
            </div>
            <div>
              <input  type="radio" @if($user->category == 'ultimate') checked @endif  id="radio_3" value="ultimate" name="category"/>
        ...
        <div class="question">
          ...
          <div class="contect">
            <div>
              <input type="radio" @if($user->contectway == 'phone') checked @endif value="phone" id="radio_4" name="contectway"/>
              <label for="radio_4" class="radio"><span>Phone</span></label>
            </div>
            <div>
              <input  type="radio" @if($user->contectway == 'email') checked @endif value="email" id="radio_5" name="contectway"/>
              <label for="radio_5" class="radio"><span>Email</span></label>
            </div>
            <div>
              <input  type="radio" @if($user->contectway == 'any') checked @endif value="any" id="radio_6" name="contectway"/>
